...
import {
  ...
  listenImage,
  toSize
} from "./chunk-TEQWWAEV.js";
import {
  Control_default,
  EventType_default as EventType_default3,
  MapEventType_default
} from "./chunk-BRQJ4ZVY.js";
import {
...
var RegularShape = class extends Image_default2 {
  /**
   * @param {Options} options Options.
   */
  constructor(options) {
...
var Icon = class extends Image_default2 {
  /**
   * @param {Options} [options] Options.
   */
  constructor(options) {
...
function drawTextOnPath(flatCoordinates, offset2, end, stride, text, startM, maxAngle, scale4, measureAndCacheTextWidth2, font, cache, rotation) {
  ...
  const endM = startM + scale4 * measureAndCacheTextWidth2(font, text, cache);
  ...
  for (let i = 0, ii = text.length; i < ii; ) {
    ...
    for (; i < ii; ++i) {
      ...
      const len = scale4 * measureAndCacheTextWidth2(font, text[index], cache);
...
var Overlay = class extends Object_default {
  ...
  getPositioning() {
    return (
      /** @type {Positioning} */
      this.get(Property5.POSITIONING)
    );
  }
  /**
   * @protected
